...
<body>
  ...
  <div class="container">
    ...
    <p>Isi data diri dan ambil foto wajah Anda untuk registrasi.</p>
    ...
    <div class="info-box">
      ...
      <ul style="margin: 8px 0 0 20px;">
        <li>Pastikan wajah Anda terlihat jelas di depan kamera.</li>
  ...
  <script>
    ...
    saveBtn.addEventListener('click', async () => {
      ...
      const response = await fetch('upload_wajah.php', {
        method: 'POST',
